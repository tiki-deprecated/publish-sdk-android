...
class TryItOutViewModel : ViewModel() {
    ...
    private var _wallets: MutableLiveData<MutableMap<String, TikiSdk>> =
        MutableLiveData(mutableMapOf())
    val wallets: LiveData<MutableMap<String, TikiSdk>>
        get() = _wallets

    private var _ownerships: MutableLiveData<MutableMap<String, TikiSdkOwnership>> =
        MutableLiveData(mutableMapOf())
    val ownerships: LiveData<MutableMap<String, TikiSdkOwnership>>
        get() = _ownerships

    private var _consents: MutableLiveData<MutableMap<String, TikiSdkConsent>> =
        MutableLiveData(mutableMapOf())
